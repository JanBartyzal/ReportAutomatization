...
> **Všechny Wave 4 (Frontend) úlohy MUSÍ dodržovat projektový design system.**
> Každý W4 soubor obsahuje sekci "UX/UI Design System (povinné)" s odkazy a kontextově specifickými pravidly.

| Dokument | Obsah |
|----------|-------|
| [`docs/UX-UI/00-project-color-overrides.md`](../UX-UI/00-project-color-overrides.md) | **Projektově specifické barvy** — brand palette, sémantické barvy, chart palette, status barvy (liší se od CIM!) |
| [`docs/UX-UI/02-design-system.md`](../UX-UI/02-design-system.md) | Kompletní design system — layout, typografie, spacing, elevace, formuláře, dark mode, a11y |
| [`docs/UX-UI/03-figma-components.md`](../UX-UI/03-figma-components.md) | Knihovna komponent — Atoms, Molecules, Organisms |
...
**Brand barva:** Crimson `#C4314B` (NE Azure Blue `#0078D4` z CIM)
