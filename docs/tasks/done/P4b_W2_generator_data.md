...
## P4b-W2-001: engine-data:query Extension – Report Data Aggregation
...
**Tasks:**
- [ ] New gRPC endpoint (internal, for engine-orchestrator):
...
## P4b-W2-002: engine-data:dashboard Extension – Generator Trigger
...
- [ ] REST endpoint: `POST /api/dashboards/generate-pptx`
  ...
  - Uses processor-generators:pptx with dashboard-specific template
