...
| **P3** | Intelligence & Admin | MS-ADMIN, MS-BATCH, MS-ATM-AI, MS-MCP, MS-TMPL | FS07, FS08, FS12, FS15 | Holdingová hierarchie + AI integrace + schema mapping |
| **P4** | Lifecycle + Period Mgmt  |MS-LIFECYCLE, MS-PERIOD | | Řízení OPEX cyklu, deadliny, stavový automat |
| **P5** | Form Builder – centrální (MS-FORM, Excel export/import) | | | Sběr dat bez Excelu po e-mailu |
| **P6** | Enterprise Features | MS-NOTIF, MS-VER, MS-AUDIT, MS-SRCH, MS-DASH (extended) | FS11, FS13, FS14, FS16 | Plná enterprise výbava: versioning, diff tool, compliance |
| **P7** | PPTX Generator (MS-TMPL-PPTX, MS-GEN-PPTX) | | |  Automatické generování standardizovaných reportů |
