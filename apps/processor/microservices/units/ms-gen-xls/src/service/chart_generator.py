...
if TYPE_CHECKING:
    ...
    from src.service.excel_renderer import ChartInput
...
class ChartGenerator:
    ...
    def _create_bar_chart(self, ws: Worksheet, chart_data: ChartInput) -> BarChart:
        ...
        Writes chart data into a hidden area of the worksheet, then creates
        Reference objects pointing to that data.
        """
        chart = BarChart()
        chart.type = "col"
    ...
    def _write_chart_data(
        ...
        Args:
            ws: The target worksheet.
            chart_data: Chart specification with labels and series.
