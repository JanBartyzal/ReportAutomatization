...
SERVICE_NAME: str = os.environ.get("SERVICE_NAME", "ms-atm-xls")
...
# Empty row threshold - skip rows with fewer non-empty cells
EMPTY_ROW_THRESHOLD: int = _int_env("EMPTY_ROW_THRESHOLD", 0)
