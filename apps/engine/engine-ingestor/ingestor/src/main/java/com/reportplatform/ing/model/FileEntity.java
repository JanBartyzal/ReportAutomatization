...
public class FileEntity {
    ...
    @Column(name = "macro_removed", nullable = false)
    private boolean macroRemoved = false;
    ...
    public boolean isMacroRemoved() {
        return macroRemoved;
    }

    public void setMacroRemoved(boolean macroRemoved) {
        this.macroRemoved = macroRemoved;
    }
