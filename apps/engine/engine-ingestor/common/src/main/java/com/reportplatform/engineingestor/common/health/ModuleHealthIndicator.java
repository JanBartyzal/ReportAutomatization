package com.reportplatform.engineingestor.common.health;
...
/**
 * Health indicator that reports status of each engine-ingestor module.
...
public class ModuleHealthIndicator implements HealthIndicator {
    ...
    private static final String[] MODULES = {"ingestor", "scanner"};
