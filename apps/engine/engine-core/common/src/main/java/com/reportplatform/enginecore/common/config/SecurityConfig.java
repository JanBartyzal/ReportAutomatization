 ...
 * Consolidates SecurityConfig from ms-auth, ms-admin, ms-batch, ms-ver, ms-audit.
 *
 * <p>Supports both JWT Bearer token (Azure Entra ID) and API key authentication.</p>
 */
@Configuration
@EnableWebSecurity
