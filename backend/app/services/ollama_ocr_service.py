"""
Ollama OCR Service for Table Extraction from PowerPoint Slides.

This service uses Ollama with the deepseek-ocr model to extract structured
table data from slide images combined with text context.
"""
...
class OllamaOCRService:
    """
    Service for extracting structured data from slides using Ollama OCR.
    
    Uses the deepseek-ocr model to analyze slide images with text context
    and extract table structures.
    """
