...
ALTER DEFAULT PRIVILEGES IN SCHEMA public
    GRANT USAGE, SELECT ON ALL SEQUENCES TO engine_core_user;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public
    GRANT USAGE, SELECT ON ALL SEQUENCES TO engine_data_user;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public
    GRANT USAGE, SELECT ON ALL SEQUENCES TO engine_reporting_user;

\c reportplatform;

RAISE NOTICE 'P8 consolidated service users and databases created successfully';
