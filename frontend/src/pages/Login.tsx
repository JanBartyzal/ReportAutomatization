            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={isLoading}
                        className="w-full py-3.5 px-4 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-lg transition-all duration-200 shadow-lg shadow-blue-900/20 flex items-center justify-center space-x-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        ...
                        <span>{isLoading ? 'Loading...' : 'Sign in with Microsoft Entra ID'}</span>
                    </button>
